...
class Database {
    constructor(id, template, config) {
        this.bases = {};
        this.get = (config) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            ...
            const bases = {};
            const ListOfBases = Object.assign({}, this.bases || {}, (config === null || config === void 0 ? void 0 : config.bases) || {});
            if (ListOfBases !== undefined) {
                for (const key in ListOfBases) {
                    if (ListOfBases.hasOwnProperty(key)) {
                        if ((_a = ListOfBases[key]) === null || _a === void 0 ? void 0 : _a.hasOwnProperty('id')) {
                            const database = ListOfBases[key];
                            const payload = yield database.get();
                            bases[key] = (0, parser_1.getBase)(payload);
                        }
                        else if ((_b = ListOfBases[key]) === null || _b === void 0 ? void 0 : _b.hasOwnProperty('length')) {
                            const payload = ListOfBases[key];
                            bases[key] = (0, parser_1.getBase)(payload);
                        }
                    }
                }
